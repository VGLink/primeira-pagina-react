...
import aparelho from "../../img/aparelho.png"
import cliente1 from "../../img/cliente01.png"
import cliente2 from "../../img/cliente02.png"
import cliente3 from "../../img/cliente03.png"
...
const Home = () => {
    return(
        <EstruturaPagina>
            ...
            <img className="img-aparelho" src= {aparelho} 
            ...
            <div className="home-depoimentos">
                ...
                <ul className="lista-depoimentos">
                    <li>
                        <img className="img-aparelho" src={cliente1} alt="Depoimento do cliente Alberto Silva" title="Depoimento do cliente Alberto Silva" />
                        <p>Alberto Silva</p>
                        <p>... "Usei aparelho por  anos e agora posso sorrir novamente."</p>
                    </li>

                    <li>
                        <img className="img-aparelho" src={cliente2} alt="Depoimento da cliente Eliana Oliveira" title="Depoimento da cliente Eliana Oliveira" />
                        <p>Eliana Oliveira</p>
                        <p>... "Meus dentes eram espaçados e depois de 2 anos estão no lugar certo."</p>
                    </li>

                    <li>
                        <img className="img-aparelho" src={cliente3} alt="Depoimento da cliente Maria Souza" title="Depoimento da cliente Maria Souza" />
                        <p>Maria Souza</p>
